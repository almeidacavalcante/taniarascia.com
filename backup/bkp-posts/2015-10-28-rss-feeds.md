...
If the feed reader can't detect the site, you can easily manually add it. Note the handy RSS button in the top right of this blog. Click on it, and you'll be taken to [https://www.almeidacavalcante.com/rss.xml](https://www.almeidacavalcante.com/rss.xml). This takes you to an awful, unreadable XML file.

The feed reader can now detect the website, add indicated by the `+` on the icon. You can choose to press `+ Follow`, or manually paste the URL (`https://www.almeidacavalcante.com/rss.xml`) into "Add feed".
